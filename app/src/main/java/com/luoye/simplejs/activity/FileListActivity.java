package com.luoye.simplejs.activity;
...
import com.luoye.simplejs.R;
import com.luoye.simplejs.adapter.FileListAdapter;
import com.luoye.simplejs.entity.FileListItem;
import com.luoye.simplejs.util.ConstantPool;
import com.luoye.simplejs.util.FileNameSort;
...
public class FileListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            curpath = new File(ConstantPool.FILE_PATH);
            if(!curpath.exists())
            {
                curpath.mkdirs();
            }
